...
$oldPriceDiv = '<h6>' . $pPriceActual . ' ' . $currencySymbol . '</h6>';
...
$discountValue = $pPrice-$salePrice;
...
$addToCartButton = "<div class='button_side2 AddToCart_$pId' onclick='addToCart(this,$pId);'>  {$_e['Buy to']}  </div>";
...
// $array['cartId']    =  $cartId;
// $array['pId']    =  $pId;
// $array['prosiz_name']    =  $dataC['prosiz_name'];
...
public function getScalesDivNew($pId, $storeId = false, $currencyId = false, $currencySymbol = false, $hasColor, $cartId)
{
$size = '';
$firstScale = true;
if ($hasColor == false) {
