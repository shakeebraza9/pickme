...
if($pId > 0 && $val['grp'] == 'userReviewMail'){
...
$p_link       =     WEB_URL."/reviews.php?pId=".$pId;
$msg        =   str_replace("{{link}}",$p_link,$msg);
}
...
if($pId > 0 && $val['grp'] == 'checkoutMail1'){


$p_link       =     WEB_URL."/orderInvoice.php?inv=".$pId;
$msg        =   str_replace("{{link}}",$p_link,$msg);
}
...
if($pId > 0 && $val['grp'] == 'checkoutMail2'){
...
$msg        =   str_replace("{{link}}",$p_link,$msg);
       ...
       */
        ...
        $mail_send  = $functions->send_phpmailer_mail($to, $subject, $msg, $headers,$returnpath,'','1');
        // $dbF->prnt($mail_send);
