...
var curTable = (function(json_data) {
    ...
    this.initializeTable = function(id) {
        ...
        if (this.initializeCheck == false) {
            ...
            $(function() {
                ...
                $panel.append("<div class='panel-heading'>" + "<h3 class='panel-title'>" +
                    panel_heading + "</h3>" +
                ...
                $panel_body.append("<div class='panel_note_footer'>" + slef_panel_note_footer +
                    "</div>");
    ...
    this.xhtmText = function(rowID, trCount) {
        ...
        return "<div class='input-group input-group-sm slotDiv_" + trCount + "'>" +
            "<span class='input-group-addon'>" +

            "<input class='slotCheckBox_" + trCount + "'  type='checkbox' value='" + rowID + "' name='" +
            this.checkbox_name + "[]'>" + "</span>" +

            "<input type='text' value='' name='" + rowID + "-" + this.input_name +
            "' class='form-control slotInput_" + trCount + " " + this.input_name__extra_class + "'>" +
            "</div>";
    ...
    this.addSlot = function() {
        ...
        for (x in data) {
            ...
            $xht = "<div class='input-group input-group-sm'>" +
                ...
                "<input type='text' class='form-control' name='" + rowID + "-" + this.input_addprice_name +
                "[" + data[x].id + "]' >" +
...
function addWeightSlot() {
    ...
    var weightVar = '<tr>' +
        ...
        '<input type="text" class="form-control" value="" name="sizeWeightName[' + uniqueId +
        ']" placeholder="<?php echo _js($_e['Size Name']); ?>">' +
        ...
        '<input type="text" class="form-control" value="" name="sizeWeight[' + uniqueId +
        ']" placeholder="<?php echo _js($_e['Weight In KG']); ?>,e.g: 200,2,0.2">' +
...
HTML;
                    ...
                    <div class="tab-pane container-fluid fade" id="tab_sizes">
                        ...
                        <button type="button" class="btn btn-info pull-rightssssssssssssssssssssss"
                            onclick="mscale.addSlot()"><?php echo _uc($_e['Add Slot']); ?>
                    ...
                    <div class="tab-pane container-fluid fade" id="tab_images">
                        ...
                        <span class="message"><?php echo _uc($_e['Drop images here to upload.']); ?>
                            <br /><i>(<?php echo _fc($_e['they will only be visible to you']); ?>)</i></span>
        ...
        if (secure_delete()) {
            ...
            $.ajax({
                ...
                if (data == '1') {
                    ...
                    jAlertifyAlert(
                        "<?php echo _js($_e['Image Not Delete Please Try Again']); ?>");
        ...
        update: function() {
            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    jAlertifyAlert(
                        "<?php echo _js($_e['There is an error, Please Refresh Page and Try Again']); ?>"
                    );
