...
class WebMenu extends object_class{
    ...
    public function menuEditSubmit(){
        ...
        if(isset($_POST['submit']) && isset($_POST['editId'])){
            ...
            $icon           = empty($_POST['icon'])      ? ""    : serialize($_POST['icon']);
   ...
   //Link
        ...
        echo '<div class="form-group">
                    ...
                    <div class="col-sm-10  col-md-9">
                        ...
                        <div class="input-group-addon '.$lang[$i].'linkList '.$lang[$i].'pointer"><i class="glyphicon glyphicon-search"></i></div>
                        </div>
                    </div>
                </div>';
 ...
 */
    ...
    public function footerMenuNew(){
        ...
        echo '<div class="form-group">
                    ...
                    <div class="col-sm-10  col-md-9">
                        <div class="input-group">
                            <input type="url" name="link" class="form-control '.$lang[$i].'pastLinkHere" placeholder="'. _uc($_e['Link']) .'">
                            <div class="input-group-addon '.$lang[$i].'linkList '.$lang[$i].'pointer"><i class="glyphicon glyphicon-search"></i></div>
                        </div>
                    </div>
                </div>';
    ...
    public function pageLinks($copyDiv=true){
        ...
        $lang   =   $this->functions->IbmsLanguages();
            ...
            $temp   .=    "<div class='form-group'>
                                ...
                                <div class='input-group col-sm-10'>
                                  <input type='text' value='$link' class='form-control fhgf'>
                                  $temp2
                                </div>
                            </div>
                          ";
