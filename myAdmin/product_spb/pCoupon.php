...
<div>
    ...
    <ul class="nav nav-tabs tabs_arrow" role="tablist" >
        ...
        <li><a href="#product_usage" role="tab" data-toggle="tab"><?php echo _uc($_e['Coupon Use']); ?></a></li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade container-fluid" id="product_usage">
            <h2 class="tab_heading"><?php echo _uc($_e['Coupon Use']); ?></h2>
            <?php $couponC->couponUse()  ?>
        </div>
    ...
    <script>
        ...
        function discountProductDel(ths){
            ...
            if(secure_delete()){
                ...
                $.ajax({
                    type: 'POST',
                    url: "product_management_spb/product_ajax.php?page=couponDel",
