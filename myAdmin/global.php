...
// include_once(__DIR__."/../_models/functions/odbController.php");

// include_once(__DIR__."/../_models/functions/odbControllerIntranet.php");
...
// $con  = new ODBController();
// $orcl_conn = $con->connn;

// $GLOBALS['orcl_conn'] = $con;




// $conIntra  = new odbControllerIntranet();
// $orcl_connIntra = $conIntra->connnIntra;

// $GLOBALS['orcl_connIntra'] = $conIntra;
