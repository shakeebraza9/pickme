<?php
$pageTitle="Inventory In Out";
ob_start();
require_once("classes/inventory.php");
$inventory = new inventory();

?>
    <h4 class="sub_heading"><?php echo _uc($_e['Inventory In Out']); ?></h4>
    <!-- Nav tabs -->
    <ul class="nav nav-tabs tabs_arrow" role="tablist">
        <li class="active"><a href="#home" role="tab" data-toggle="tab"><?php echo _uc($_e['Inventory In Out']); ?></a>
        </li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade in active container-fluid" id="home" ng-app="inventory0"
            ...
            <h2 class="tab_heading"><?php echo _uc($_e['View Inventory In Out']); ?></h2>
            <?php
             $inventory->InventoryInOut();
