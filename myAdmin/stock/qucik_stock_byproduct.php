...
if(isset($_POST["pid"]) && isset($_POST["submit"])  && isset($_POST["qty"]) ){
 ...
 $migrate_products = $functions->ibms_setting('migrate_product_to_ch');
        $migrate_product_to_intranet = $functions->ibms_setting('migrate_product_to_intranet');
            ...
            $sql1 = "DELETE FROM product_inventory WHERE qty_product_id = '$new_pid'";
            $con->setRow($sql1);
    ...
    // $new_pid = $pid;
            ...
            $sql1 = "DELETE FROM product_inventory WHERE qty_product_id = '$pid'";
            $conIntra->setRow($sql1);
            ...
            foreach($data as $store_id=>$store_val){
                ...
                foreach($store_val as $scale_id=>$scale_val) {
                    ...
                    foreach($scale_val as $color_id=>$color_val) {
                        ...
                        $scaleId1 = empty($scale_id) ? 0 :'ss'.$scale_id;
                        $colorId1 = empty($color_id) ? 0 :'ss'.$color_id;
