...
class product_function extends object_class{
    ...
    public function productTotalPrice($productId,$scaleId,$colorId,$customId,$countryPK,$symbol='before/after/false',$betweenSymbol=' '){
        ...
        if(isset($scalePrice['prosiz_price'])){
            $scalePrice = $scalePrice['prosiz_price'];
        }
            $scalePrice=floatval($scalePrice);

        $colorPrice=$this->colorPrice($colorId,$currId,$productId);
        if(isset($colorPrice['proclr_price'])){
            $colorPrice = $colorPrice['proclr_price'];
        }
            $colorPrice=floatval($colorPrice);
        $customPrice = 0;
    ...
    public function scalePrice($scaleId,$currId,$pid){
        ...
        */
        ...
        if(isset($temp['prosiz_name'])){
            $colorPrice = $temp['prosiz_name'];
        }
        else{
            $colorPrice = '';
        }
        $scaleName=$colorPrice;
        $sql="";
    ...
    public function colorPrice($colorId,$currId,$pid){
       ...
       */
        ...
        $temp=$this->dbF->getRow($sql);
        if(isset($temp['proclr_name'])){
            $proclr_name = $temp['proclr_name'];
        }
        else{
            $proclr_name = '';
        }
        $colorName=$proclr_name;
        $sql="";
...
//get sale offer
    ...
    public function has_buy_get_free_offer($order_id,$product_id) {
        ...
        if(isset($colorPrice['proclr_price'])){
            $settingVal = $data["setting_val"];
        }
        else{
            $settingVal = '';
        }
        $buy_get_free   = $settingVal;
