...
$pageLink = "/".sanitize_slug('pCategory-'.$node);
            $slug = $node;
            $ref_id = 'pCategory-'.$node;

            //$this->addSeo($pageLink, $slug, $ref_id);
            ...
            VALUES (?, ?, ?, ? , ? , ?, ?, ? , ? ) ";
            $array = array($ref_id,$slug,$pageLink,1,1,1,'1 week','category',$public);
	...
	public function addSeo($pageLink, $slug, $ref_id)
	{
		...
		$sql = " INSERT INTO `seo` (
            ...
            VALUES ('$ref_id', '$slug', '$pageLink', 1 , 1 , 1, '1 week','category' , $public ) ";
            //$this->db->query($sql);
	}
}