...
class ajax extends object_class{
    ...
    public function AjaxDelScript_product()
    {
        try{
            ...
            $sql3="DELETE FROM `product_image_spb` WHERE `product_id`= ?";
            $this->dbF->setRow($sql3,array($id));

            $sql3="DELETE FROM `proudct_detail_spb` WHERE `prodet_id`= ? ";
            $this->dbF->setRow($sql3,array($id));
    ...
    public function AjaxDelScript_productImageDel(){
        ...
        $sql3="DELETE FROM `product_image_spb` WHERE `img_id`= ? ";
        $this->dbF->setRow($sql3,array($id));
    ...
    public  function pImageAltUpdate(){
        $id= htmlspecialchars($_POST['imageId']);
        $alt=$_POST['altT'];
    ...
    public  function sortProducts(){
        $list=  htmlspecialchars($_POST['sort']);
        for ($i = 0; $i < count($list); $i++) {
