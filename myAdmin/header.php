...
<head>
    ...
    <script type="text/javascript"
        src="<?php echo WEB_ADMIN_URL; ?>/assets/biggora-bootstrap-ajax-typeahead/js/bootstrap-typeahead.js" />
    </script>
    ...
    <!--Alertify css-->
    <link rel="stylesheet" type="text/css"
        href="<?php echo WEB_ADMIN_URL; ?>/assets/alertify/themes/alertify.core.css" />
