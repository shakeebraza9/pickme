...

{
...

    {
        ...
        $this->AutoVisibleMenu = '';

        $this->AutoVisibleMenuLink = '';

        $this->AutoVisibleMenuName = '';
        ...
        <ul>
            ...
            <li class="' . $this->checkActive('product','Products') . '">
                ...
                <ul>
                    ...
                    <li ' . $this->checkSubMenu('Product Sale','-product?page=pSale') . '><a href="-product?page=pSale">' . $_e['Product Whole Sale'] .'</a></li>

                    <li ' . $this->checkSubMenu('Product Coupon','-product?page=pCoupon') . '><a href="-product?page=pCoupon">' . $_e['Product Coupon'] .'</a></li>

                    <li ' . $this->checkSubMenu('Measurement','-measurement?page=measurement',true) . '><a href="-measurement?page=measurement">' . $_e['Measurement'] .'</a></li>
           ...
           <li class="' . $this->checkActive('stock','Stock Management') . '">
            ...
            <li class="' . $this->checkActive('orderManagement','Order Management') . '">
            ...
            <li class="' . $this->checkActive('statics','Statics') . '">
            ...
            <li class="' . $this->checkActive('statisticM','New Statistics') . '">
            ...
            <li class="' . $this->checkActive('shippingManagement','Shipping Management') . '">
            ...
            <li class="' . $this->checkActive('logs','Logs Management') . '">
            ...
            <li class="' . $this->checkActive('pages','Pages') . '">
                ...
                <ul>
                    ...
                    <li ' . $this->checkSubMenu('brands',"-brands?page=brands",true) . '><a href="-brands?page=brands">' . $_e['Brands'] .'</a></li>
            ...
            <li class="' . $this->checkActive('newsM','News & Events',true) . '">
            ...
            <li class="' . $this->checkActive('emailin_waitingM','emailin_waiting') . '">
            ...
            <li class="' . $this->checkActive('seoM','SEO Management') . '">
             ...
             <li class="' . $this->checkActive('giftCardM','Gift Card Management') . '">
           ...
           <li class="' . $this->checkActive('adminSetting','Setting') . '">
                ...
                <ul>
                    ...
                    <li ' . $this->checkSubMenu('hardWords',"-setting?page=hardWords") . '><a href="-setting?page=hardWords">' . $_e['Translate Language'] .'</a></li>
            ...
            <li class="' . $this->checkActive('emailM','Subscribe Email') . '">
                ...
                <ul>
                    ...
                    <li ' . $this->checkSubMenu('allProductsInfo',"-product?page=allProductsInfo",true) . '><a href="-product?page=allProductsInfo">' . $_e['Products List'] .'</a></li>
            ...
            <li class="' . $this->checkActive('webUserM','Users') . '">
                ...
                <ul>
                    ...
                    <li ' . $this->checkSubMenu('reviews',"-webUsers?page=reviews") . '><a href="-webUsers?page=reviews">' . $_e['Reviews'] .'</a></li>

                    <li ' . $this->checkSubMenu('questions',"-webUsers?page=questions") . '><a href="-webUsers?page=questions">' . $_e['Questions'] .'</a></li>
