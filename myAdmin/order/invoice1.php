    ...
    <div class="table-responsive newProduct col-sm-10">
        <form action="" method="post" id="email_template_form">
            ...
            <div class="main_portion">
                ...
                <!--hd_no1 close-->
                <div class="">
                    <select  style="" id="email_temp" class="form-control">
                        <option disabled selected>Select Email Template</option>
                        <?php echo $invoice->productF->getOrderEmailTemplate(); ?>
                    </select>
                </div>
                <div class="col_select_portion">
                    <input type="text" class="form-control" id="titleHtml" name="titleHtml" placeholder="<?php echo _uc($_e['LETTER TITLE FOR ADMIN']); ?>" value="KONTAKTA KUND"/>
                </div>

                <div class="col_select_portion">
                    <input type="text" class="form-control" id="nameHtml" name="nameHtml" placeholder="<?php echo _uc($_e['FROM NAME']); ?>" value="Sharkspeed Kundtjänst" />
                </div>

                <div class="col_select_portion">
                    <input type="text" class="form-control" id="mailHtml" name="mailHtml" placeholder="<?php echo _uc($_e['FROM MAIL']); ?>" value="helpdesk@sharkspeed.com" />
                </div>

                <div class="col_select_portion">
                    <input type="text" class="form-control" id="subjectHtml" name="subjectHtml" placeholder="<?php echo _uc($_e['SUBJECT']); ?>" value="Order information" />
                </div>
                <!--col_select_portion close-->
