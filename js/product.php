...
$.ajax({
type: "POST",
url: "<?php echo WEB_URL;?>/_models/functions/products_ajax_functions.php?page=getSearchJsontxt_search_cat",
data: {val:values},
beforeSend: function(){
},
success: function(data){
...
// checkout_trigger.find('.out_of_stock.scale_id').val(scaleId);
// checkout_trigger.find('.out_of_stock.store_id').val(storeId);
...
// data1 = {cartId: cartId,pId: pId, storeID: storeId, scaleId: scaleId, colorId: colorId};
...
url = "<?php echo WEB_URL;?>/_models/functions/products_ajax_functions.php?page=sizeCartUpdate";
$.ajax({
type: "POST",
url: url,
data: {cartId: cartId,pId: pId, storeID: storeId, scaleId: scaleId, colorId: colorId}
}).done(function (data){
...
if(<?php echo $check_stock; ?> == '1' || hasFreePro_ == '1'){
...
if(resp_imge == 0){
//console.log(resp_imge+"9999999999sdsdasdasdsad4545");
$('.pop_side').hide();
}else if(resp_imge == 1){
//console.log(resp_imge+"9999999999sdsdasdasdsad4545");
$('.pop_btn').hide();
...
// var cartId = parsed_data.cartId;
// var pId = parsed_data.pId;

// var prosiz_name = parsed_data.prosiz_name;
// $('#sample_select_'+cartId+'_'+pId+' > dt > a > span').html(prosiz_name);



// console.log("111111111aaaaaaaaaa");         

// $('#sample_select_'+cartId+'_'+pId+' dd a').click(function() {       

// console.log("3333333aaaaaaaaaa");         
// save the selected size
// var size_selected = $(this).find('div.color_name.size').html();


// console.log(size_selected+"aaassssasasa123");         
// alert(prosiz_name);
...
//   console.log("sssssssss123123123123");
...
// out_of_checkout_trigger(parsed_data.invoiceId);
