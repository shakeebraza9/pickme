            ...
            <div class="contact_side">
                <div class="standard">
                    ...
                    <div class="location wow fadeInDown">
                        <iframe src="<?php echo $locationmap; ?>" width="1350" height="400" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                    </div>
                    <div class="icon1 wow fadeInLeft">
                        <?php $box11 = $webClass->getBox('box11'); ?>
                        <a href="tel:<?php echo str_replace("-", "", $box11['linkText'])?>"><img src="<?php echo $box11['image'] ?>" alt="">
                            <div class="icon1_txt"><?php echo $box11['linkText'] ?> </div>
                        </a> 
                        <!-- icon1_txt close -->
                    </div>
                    <!-- icon1 close -->
                    <?php $box2 = $webClass->getBox('box2'); ?>
                    <div class="icon1 wow fadeInRight"> 
                        <a href="mailto:<?php echo $box2['linkText'] ?>">
                            <img src="<?php echo $box2['image'] ?>" alt="">
                            <div class="icon1_txt">
                                <?php echo $box2['linkText'] ?>
                            </div>
                        </a>   
                        <!-- icon1_txt close -->
                    </div>
