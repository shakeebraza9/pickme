...
<div><?php echo $this->dbF->hardWords('Free Gift Ready', false); ?></div>
 <form action='orderInvoice.php?ds=freeGift_ai_id' method='post' id="cart_side_form">
            <?php
            ...
            ?>
                ...
                <input type="submit" class="submit_side2" id="cart_side_grandtotal3333" value="<?php echo $this->dbF->hardWords('Go To Direct Checkout', false); ?>">
 ...
 ?>
            ...
            <div id="staple_product_text"></div>
 ...
 <div class="pc_text" id="coupon_text" ></div>
            ...
            <div class="main_box_side_inner" id="gft_id">
                <div class="box_1_side">
